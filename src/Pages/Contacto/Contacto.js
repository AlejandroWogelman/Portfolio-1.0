        ...
        <Row className="caja-formulario justify-content-center ">
            ...
            <div  className="formulario col-md-7 col-sm-12  animate__animated animate__pulse">
                ...
                <Form onSubmit={handleSubmit(handleInputs)} ref={refForm}>
                    ...
                    <Form.Group>
                            <Form.Label className="m-0 label" htmlFor="nombre">Nombre completo</Form.Label>
                    ...
                    <Form.Group>
                            <Form.Label className="m-0 label" htmlFor="asunto">Asunto</Form.Label>
                            <Form.Control {...register("asunto") } type="text" id="asunto"/>
                           
                    </Form.Group>

                    <Form.Group>
                            <Form.Label className="m-0 label" htmlFor="email"> Email</Form.Label>
                            <Form.Control {...register("email",{required:true})} type="email" id="email"/>
                            {errors.email && <span className="alert-form">email requerido</span> }
                    </Form.Group>

                    <Form.Group>
                            <Form.Label  className="m-0 label" htmlFor="detalles">Detalles</Form.Label>
